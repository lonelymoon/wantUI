...
var WantConfirm = function(){
	this.beforeIE7 = document.querySelector ? false : true;
	this.init();
};

WantConfirm.prototype = {

	init : function(){
		this.layer = document.getElementById('wantUI-confirm-box');
		this.ele = document.getElementById('wantUI-confirm-dialog');
		this.succCallback = function(){};
		this.cancCallback = function(){};
	...
	setValues : function(options){
		...
		/********提示框按钮*********/
		this.pass = options.pass || this.pass || "确认";
		this.cancel = options.cancel || this.cancel || "取消";
		//按钮点击后的回调函数
		this.succCallback = options.succCallback || this.succCallback || function(){};
		this.cancCallback = options.cancCallback || this.cancCallback || function(){};
		/********系统选项*********/
	...
	__initDom : function(){
		var title = document.getElementById("wantUI-confirm-title"),
			msg = document.getElementById("wantUI-confirm-msg"),
			pass = document.getElementById("wantUI-confirm-pass"),
	...
	__bindEvent : function(){	
		...
		pass.onclick = function(e){
			_self.custom();
			_self.succCallback.call(_self,e);
		};

		cancel.onclick = function(e){
			_self.custom();
			_self.cancCallback.call(_self,e);
		};
...
if( typeof module != "undefined" && module.exports ){
	module.exports = new WantConfirm();
} else if( typeof define == "function" && define.amd ){
	define(function(){ return new WantConfirm();});
} else {
	window.wantConfirm = new WantConfirm();
}
